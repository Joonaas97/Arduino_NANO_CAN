...
ISR(TIMER1_COMPA_vect) {
        ...
        delayMicroseconds(52); //1
         //PORTC =B00000000; 
         PORTD =B00000000;      
        delayMicroseconds(26); //2

        //PORTD= B00111100 ;
        PORTC= B00001111 ;         
 

        delayMicroseconds(26); //3

         //PORTD =B00000000;
         PORTC =B00000000;
         delayMicroseconds(26); //4

        //PORTD= B00111100;
        PORTC= B00001111 ;
                delayMicroseconds(26);  //5
        
        //PORTD =B00000000;
        PORTC =B00000000;
                delayMicroseconds(26);  //6
        
        //PORTD= B00111100;
        PORTC= B00001111 ;
                delayMicroseconds(26);  //7
        
        //PORTD =B00000000;
        PORTC =B00000000;
                 delayMicroseconds(52); //8
        
        //PORTD= B00111100;
        PORTC= B00001111 ;
                delayMicroseconds(51);  //9
        
        //PORTD =B00000000;
        PORTC =B00000000;
                 delayMicroseconds(51); //10
        
        //PORTD= B00111100;
        PORTC= B00001111 ;
                delayMicroseconds(51);  //11
        
        //PORTD =B00000000;
        PORTC =B00000000;
                 delayMicroseconds(51); //12
        
        //PORTD= B00111100;
        PORTC= B00001111 ;
                delayMicroseconds(26);  //13
        
        //PORTD =B00000000;
        PORTC =B00000000;
                 delayMicroseconds(26); //14
        
        //PORTD= B00111100;
        PORTC= B00001111 ;
                delayMicroseconds(26);    //15
